...
source("/mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/repeatsamp.r")

########### 1. Run MCMC, BAS and SRSWOR for simulated data  #################
nsim <- 100;

# RS
system("gcc -g -O2 -o /mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/sim-rs /mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/sim-rs.c -llapack -lblas -lm")

system("/mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/sim-rs")


# RS-Thin
system("gcc -g -O2 -o /mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/sim-rs-thin /mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/sim-rs-thin.c -llapack -lblas -lm")
system("/mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/sim-rs-thin")


# MC^3
system("gcc -g -O2 -o /mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/sim-mc3 /mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/sim-mc3.c -llapack -lblas -lm")
system("/mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/sim-mc3")
...
for (isim in 1:nsim)
  {
   ...
   save(sim.bas.ep,file=paste("/mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/sim.bas.ep",isim,"Rdata",sep="."))
   # BAS-uniform
   ...
   save(sim.bas.unif,file=paste("/mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/sim.bas.unif",isim,"Rdata",sep="."))
   # SRSWOR
   sim.srs <- bas.lm(y~.,data=multidata,n.models=3276,prior="g-prior",update=NULL,alpha=nrow(multidata),initprobs="Uniform")
   save(sim.srs,file=paste("/mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/sim.srs",isim,"Rdata",sep="."))
  }


# SRSWOR and BAS over a grid 1,2... 10% of 2^15
bas.100 <- repeatsamp.bas(100)
save(bas.100,file="/mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/bas.100.Rdata")

srs.100 <- repeatsamp.srs(100)
save(srs.100,file="/mn/anatu/ansatte-u3/aliaksah/Desktop/competotrs/srs.100.Rdata")
...
# RS-Thin
system("gcc -g -O2 -o crime-rs-thin crime-rs-thin.c -llapack -lblas -lm")
system("./crime-rs-thin")
...
# RS-Thin
system("gcc -g -O2 -o protein-rs-thin protein-rs-thin.c -llapack -lblas -lm")
system("./protein-rs-thin")
...
system("gcc -g -O2 -o protein-rsthin-pred protein-rsthin-pred.c -llapack -lblas -lm")  # compile C code
system(paste("./protein-rsthin-pred",casename,sep=" ")) # Run for ith case deleted
  }
