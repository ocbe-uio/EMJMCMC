...
for(j in 1:100)
{
  ...
  write.csv(x =posteriors,row.names = F,file = paste0("parres/posteriorsbreast_",j,".csv"))
...
write.csv(x = cbind(keys(featgmj),values(featgmj)),file = paste0("parres/spamfeatmj",1,".csv"))
