...
multi.all <- bas.lm(y~.,data=multidata,n.models=2^15,prior="g-prior",update=500,modelprior= uniform(),
...
mat <- cbind(top100000.bas.ep,NA,top100000.bas.unif,NA,top100000.rsthin.full,NA,top100000.bas.rst.rm,NA,top100000.bas.rst.mc)

#postscript("proteintop100000.hybrid.bash.basep.ps",width=13,height=5,horizontal=TRUE)
boxplot(mat[,1:54],xaxt="n",ylab="log(Marginal Likelihood)",xlab="Replicates",horizontal=FALSE,pch=".",cex.lab=1.7,cex.axis=1.5,
        omd=c(0,0.7,0,0.7))
mtext(side=3,at=seq(5,5*11,by=11),line=0.5,las=1,text=c("BAS\neplogp","BAS\nuniform","RST","BAS\nRST-RM","BAS\nRST-MC"),cex=1.3)
axis(side=1,at=(1:54)[-11*(1:4)],labels=FALSE,tick=TRUE,cex=0.2)
at.vec <- c(seq(1,10,by=2),seq(12,21,by=2),seq(23,32,by=2),seq(34,43,by=2),seq(45,54,by=2))
