...
Double_Matrices::Double_Matrices()
{
  nb_rows=0;
  nb_columns=0;
}

void Double_Matrices::Alloc_double_matrix(int Rows,
					  int Columns)
{
...
void Double_Matrices::Replicate_double_matrix(Double_Matrices Source)
{
  
  Alloc_double_matrix(Source.nb_rows,Source.nb_columns);
...
void Double_Matrices::Free_double_matrix()
{
...
void Double_Matrices::Read_from_file(char *filename)
{
...
void Double_Matrices::Display_matrix()
{
  for(int current_line=0;current_line<nb_rows;current_line++){
    for(int current_column=0;current_column<nb_columns;current_column++){
...
void Double_Matrices::Display_matrix_header()
{
...
void Double_Matrices::Write_to_file(char *filename)
{
