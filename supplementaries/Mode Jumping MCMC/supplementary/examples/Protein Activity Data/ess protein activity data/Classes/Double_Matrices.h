...
#ifndef DOUBLE_MATRICES_H
#define DOUBLE_MATRICES_H 1
...
public:
  ...
  void Alloc_double_matrix(int Rows,
			   int Columns);
  void Replicate_double_matrix(Double_Matrices Source);
