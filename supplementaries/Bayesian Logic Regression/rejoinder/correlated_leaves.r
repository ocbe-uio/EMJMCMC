...
res4J = LogicRegr(formula = formula1,data = data.example,family = "Gaussian",prior = "J",report.level = 0.5,d = 10,cmax = 2,kmax = 5,p.and = 0.9,p.not = 0.1,p.surv = 0.2,ncores = 5)
